...
exports.getRoomByCode = exports.createRoom = void 0;
...
const createRoom = async (req, res) => {
    try {
        ...
        let codeExists = await prisma_1.default.room.findUnique({ where: { code } });
        while (codeExists) {
            code = generateRoomCode();
            codeExists = await prisma_1.default.room.findUnique({ where: { code } });
        }
